...
def accuracy_1k(y_true, y_pred):
    return tf.py_function(func=lambda y_true, y_pred: accuracy_k(y_true, y_pred, 0), inp=[y_true, y_pred], Tout=tf.float32)

def accuracy_2k(y_true, y_pred):
    return tf.py_function(func=lambda y_true, y_pred: accuracy_k(y_true, y_pred, 1), inp=[y_true, y_pred], Tout=tf.float32)

def accuracy_3k(y_true, y_pred):
    return tf.py_function(func=lambda y_true, y_pred: accuracy_k(y_true, y_pred, 2), inp=[y_true, y_pred], Tout=tf.float32)

def accuracy_10k(y_true, y_pred):
    return tf.py_function(func=lambda y_true, y_pred: accuracy_k(y_true, y_pred, 9), inp=[y_true, y_pred], Tout=tf.float32)
...
def precision_10k(y_true, y_pred):
    return tf.py_function(func=lambda y_true, y_pred: precision_k(y_true, y_pred, 9), inp=[y_true, y_pred], Tout=tf.float32)
...
def recall_10k(y_true, y_pred):
    return tf.py_function(func=lambda y_true, y_pred: recall_k(y_true, y_pred, 9), inp=[y_true, y_pred], Tout=tf.float32)
...
def F1_10k(y_true, y_pred):
    return tf.py_function(func=lambda y_true, y_pred: F1_k(y_true, y_pred, 9), inp=[y_true, y_pred], Tout=tf.float32)
